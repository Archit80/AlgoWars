...
const HeroSection = () => {
  ...
  <section className="relative px-4 pb-16 pt-48 h-full  text-center">
    <div className="absolute inset-0 h-full blur-[2px] bg-black/10" style={{ position: 'absolute', inset: 0 }}>
      <FaultyTerminal
        scale={1.8}
        digitSize={1.6}
        timeScale={0.6}
    ...
    <div className="relative z-10 mt-10 max-w-4xl mx-auto"> 
      ...
      <p className="text-xl lg:text-2xl font-medium text-white mb-8 max-w-2xl mx-auto">
        ...
        real-time. Level up your skills, dominate the leaderboard, and become a
        coding legend.
      </p>
