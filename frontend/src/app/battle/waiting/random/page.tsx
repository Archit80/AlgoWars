...
export default function RandomWaitingRoom() {
  ...
  useEffect(() => {
    ...
    console.log(`[Random Waiting] Setting up socket for user: ${supabaseUser.id}`);
    ...
    const setupSocket = () => {
      ...
      console.log(`[Random Waiting] Joining user room: ${supabaseUser.id}`);
      joinUserRoom(supabaseUser.id);
    ...
    return () => {
      ...
      console.log(`[Random Waiting] Socket cleanup completed for user: ${supabaseUser.id}`);
    };
